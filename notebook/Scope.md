...
## Grammar
```
# PEG grammar for Gradual Dependent Python
...
function_def_raw:
    | 'def' NAME [type_params] '(' [params] ')' ['->' expression dependent_predicate?] ':' [func_type_comment] block 
...
dependent_annotation: ':' expression dependent_predicate
